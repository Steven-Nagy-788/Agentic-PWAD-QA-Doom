...
class TestReport(Base):
    ...
    __table_args__ = (
        Index("idx_test_reports_generation_status", "generation_status"),
    )
    ...
    objectives_planned: Mapped[list[dict[str, Any]] | dict[str, Any] | None] = mapped_column(JSONB)
    objectives_covered: Mapped[list[dict[str, Any]] | dict[str, Any] | None] = mapped_column(JSONB)
    objectives_omitted: Mapped[list[dict[str, Any]] | dict[str, Any] | None] = mapped_column(JSONB)
