...
def test_spawn_summary_respects_doom_skill_flags(test_wad_path: str) -> None:
    wad = WAD(test_wad_path)
...
def test_map_metadata_falls_back_to_filename_and_map_name(test_wad_path: str) -> None:
    metadata = map_metadata_for_wad(test_wad_path, "thelonghallways.wad")
